...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        boolean sameColor = this.getCount() == otherEq.getCount();
       
        boolean sameWeight = this.getTotalWeight() == otherEq.getTotalWeight();
        boolean sameHeight = this.getTotalPrice() == otherEq.getTotalPrice();
        
        boolean sameDescription = this.getDescription().equals(otherEq.getDescription());
        
        /* return TODO; */
        return sameName & sameColor & sameWeight & sameHeight && sameDescription;
